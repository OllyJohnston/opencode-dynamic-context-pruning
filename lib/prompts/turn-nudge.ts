...
- **MANDATORY PRIORITY**: You MUST evaluate and compress these ranges BEFORE proceeding with the user's latest request. Context hygiene is non-negotiable for session stability.
